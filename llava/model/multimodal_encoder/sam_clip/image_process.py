...
class DeepOCRProcessor(ProcessorMixin):
    ...
    def tokenize_with_images(
        ...
        conversation = PROMPT * len(images)
        # print("conversation:", conversation)
        # print("images:", images)
        assert conversation.count(self.image_token) == len(images), (
            f"Number of image tokens ({conversation.count(self.image_token)}) "
            f"does not match number of provided images ({len(images)})."
        )
