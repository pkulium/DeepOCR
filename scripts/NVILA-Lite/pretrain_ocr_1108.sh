...
#!/bin/bash
# ulimit -u 8192
DEFAULT_RUN_NAME="ocr-qwen2-vl-8b-pretrain-sam_clip_data_mix"
...
OUTPUT_DIR=${3:-"runs/train/ocr-qwen2-vl-8b-pretrain-sam_clip_data_mix"}
...
DATA_MIXTURE="olmOCR-mix-pretrain+vary_pdf_cn_30w+vary_pdf_en_30w+synthdog-en+synthdog-zh"
